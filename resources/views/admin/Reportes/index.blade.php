...
<body class="bg-[#f8fafc] font-sans text-gray-800" x-data="{ showPreviewModal: false, sidebarOpen: false }">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <main class="flex-1 flex flex-col h-full overflow-hidden min-w-0">
            ...
            <div class="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8 pt-4 md:pt-6 custom-scrollbar">
                ...
                <div class="mb-6">
                    <h1 class="text-2xl md:text-3xl font-black text-gray-900 tracking-tight">Reportes y Estadísticas</h1>
                ...
                <form method="GET" action="{{ route('admin.reportes.index') }}" 
                      class="bg-white p-4 md:p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col md:flex-row flex-wrap gap-4 items-end mb-6 md:mb-8">
                    
                    <div class="flex-1 w-full md:w-auto min-w-[150px]">
                    ...
                    <button type="submit" class="w-full md:w-auto px-6 py-2.5 bg-gray-800 hover:bg-gray-900 text-white rounded-xl text-sm font-bold shadow-md transition-colors h-[42px] flex items-center justify-center gap-2">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 md:gap-6 mb-6 md:mb-8">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 p-4 md:p-5 shadow-sm flex flex-col gap-2 md:gap-3">
                        ...
                        <div>
                            <p class="text-[10px] md:text-[11px] font-black text-gray-400 uppercase tracking-wider mb-0.5">Total de Ventas</p>
                            <p class="text-xl md:text-2xl font-black text-gray-900 leading-none">{{ $totalVentas ?? 0 }}</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 p-4 md:p-5 shadow-sm flex flex-col gap-2 md:gap-3">
                        ...
                        <div>
                            <p class="text-[10px] md:text-[11px] font-black text-gray-400 uppercase tracking-wider mb-0.5">Ingresos Acumulados</p>
                            <p class="text-xl md:text-2xl font-black text-[#0f763e] leading-none">${{ number_format($totalIngresos ?? 0, 2) }}</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 p-4 md:p-5 shadow-sm flex flex-col gap-2 md:gap-3">
                        ...
                        <div>
                            <p class="text-[10px] md:text-[11px] font-black text-gray-400 uppercase tracking-wider mb-0.5">Ticket Promedio</p>
                            <p class="text-xl md:text-2xl font-black text-gray-900 leading-none">${{ number_format($ticketPromedio ?? 0, 2) }}</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 p-4 md:p-5 shadow-sm flex flex-col gap-2 md:gap-3">
                        ...
                        <div class="overflow-hidden">
                            <p class="text-[10px] md:text-[11px] font-black text-gray-400 uppercase tracking-wider mb-0.5">Producto Top</p>
                            <p class="text-base md:text-lg font-bold text-gray-900 truncate" title="{{ $productoMasVendido ?? 'N/A' }}">{{ $productoMasVendido ?? 'N/A' }}</p>
                        </div>
                    </div>

                    <div class="bg-white rounded-2xl border border-gray-100 p-4 md:p-5 shadow-sm flex flex-col gap-2 md:gap-3 sm:col-span-2 lg:col-span-1 xl:col-span-1">
                        ...
                        <div class="overflow-hidden">
                            <p class="text-[10px] md:text-[11px] font-black text-gray-400 uppercase tracking-wider mb-0.5">Top Cajero</p>
                            <p class="text-base md:text-lg font-bold text-gray-900 truncate" title="{{ $cajeroTop ?? 'N/A' }}">{{ $cajeroTop ?? 'N/A' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 mb-8">
                    <div class="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div class="h-56 md:h-64 relative w-full">
                    ...
                    <div class="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col">
                        <h3 class="font-bold text-gray-900 mb-4">Categorías</h3>
                        <div class="flex-1 flex items-center justify-center relative min-h-[220px] md:min-h-[256px] w-full">
                ...
                <div class="flex flex-col sm:flex-row flex-wrap gap-3 sm:justify-end pt-4 border-t border-gray-200 mt-4 pb-4">
                    <button @click="showPreviewModal = true" class="w-full sm:w-auto justify-center px-5 py-2.5 bg-[#0369a1] hover:bg-[#0284c7] text-white rounded-xl text-sm font-bold shadow-md shadow-blue-100 transition-colors flex items-center gap-2">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                        Vista Previa
                    </button>
                    <a href="{{ route('admin.reportes.export.excel', request()->all()) }}" class="w-full sm:w-auto justify-center px-5 py-2.5 bg-[#107c41] hover:bg-[#0c5e31] text-white rounded-xl text-sm font-bold shadow-md shadow-green-100 transition-colors flex items-center gap-2">
                    ...
                    <a href="{{ route('admin.reportes.export.pdf', request()->all()) }}" class="w-full sm:w-auto justify-center px-5 py-2.5 bg-[#b91c1c] hover:bg-[#991b1b] text-white rounded-xl text-sm font-bold shadow-md shadow-red-100 transition-colors flex items-center gap-2">
