        ...
        <form action="{{ route('admin.usuarios.store') }}" method="POST" class="p-6 pt-2 space-y-4">
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative">
                    ...
                    <select name="role" required class="w-full pl-11 pr-10 py-2.5 bg-gray-50/50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:bg-white focus:border-[#0f763e] focus:ring-1 focus:ring-[#0f763e] transition-all font-medium text-gray-800 appearance-none cursor-pointer">
