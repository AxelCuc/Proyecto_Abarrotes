...
>
    ...
    >
        ...
        <form :action="'/admin/usuarios/' + selectedUser.id" method="POST" class="p-6 space-y-4">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nombre" x-model="selectedUser.nombre" required
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative">
                    ...
                    <select name="rol" x-model="selectedUser.rol" class="w-full pl-11 pr-10 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#0f763e] focus:ring-1 focus:ring-[#0f763e] transition-all font-medium text-gray-800 appearance-none cursor-pointer">
