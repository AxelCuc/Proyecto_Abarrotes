                            ...
                            @forelse($productos as $producto)
                                <tr class="fila-producto hover:bg-gray-50/80 transition-colors group">
                                    <td class="px-8 py-4 whitespace-nowrap">
                                        <div class="w-16 h-16 bg-gray-100 rounded-xl overflow-hidden border border-gray-100 shadow-sm mx-auto">
                                            @if($producto->imagen)
                                                <img src="{{ asset('storage/' . $producto->imagen) }}" 
                                                     alt="{{ $producto->nombre }}" 
                                                     class="w-full h-full object-cover">
                                            @else
                                                <div class="flex items-center justify-center w-full h-full text-gray-400 text-[10px] text-center leading-tight font-medium">
                                                    Sin<br>imagen
                                                </div>
                                            @endif
                                        </div>
